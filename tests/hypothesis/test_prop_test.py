...
class TestPropTestOneSample:
    ...
    def test_basic(self):
        """
        R: prop.test(30, 100, null_value=0.5)
        X-squared = 15.21, df = 1, p-value = 9.619e-05
        """
        result = prop_test(30, 100, null_value=0.5)
    ...
    def test_no_correction(self):
        """
        R: prop.test(30, 100, null_value=0.5, correct=FALSE)
        X-squared = 16, p-value = 6.334e-05
        """
        result = prop_test(30, 100, null_value=0.5, correct=False)
    ...
    def test_alternative_less(self):
        """
        R: prop.test(30, 100, null_value=0.5, alternative="less")
        """
        result = prop_test(30, 100, null_value=0.5, alternative="less")
        assert result.statistic == pytest.approx(15.21, rel=1e-10)
    ...
    def test_alternative_greater(self):
        """
        R: prop.test(30, 100, null_value=0.5, alternative="greater")
        """
        result = prop_test(30, 100, null_value=0.5, alternative="greater")
        assert result.statistic == pytest.approx(15.21, rel=1e-10)
    ...
    def test_zero_successes(self):
        """
        R: prop.test(0, 100, null_value=0.5)
        """
        result = prop_test(0, 100, null_value=0.5)
    ...
    def test_custom_conf_level(self):
        """
        R: prop.test(30, 100, null_value=0.5, conf.level=0.99)
        """
        result = prop_test(30, 100, null_value=0.5, conf_level=0.99)
        assert result.statistic == pytest.approx(15.21, rel=1e-10)
        assert result.p_value == pytest.approx(9.6192688035205337e-05, rel=1e-10)
        assert_allclose(
            result.conf_int,
