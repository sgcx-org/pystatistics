...
class TestBasicRun:
    def test_returns_solution(self, small_missing):
        sol = mice(small_missing, n_imputations=3, max_iter=4, seed=0)
        assert isinstance(sol, MICESolution)
        assert sol.n_imputations == 3
        assert sol.max_iter == 4

    def test_completed_datasets_have_no_nan(self, small_missing):
        sol = mice(small_missing, n_imputations=3, max_iter=3, seed=0)
    ...
    def test_observed_values_preserved(self, small_missing):
        sol = mice(small_missing, n_imputations=2, max_iter=3, seed=0)
    ...
    def test_iteration_yields_m_datasets(self, small_missing):
        sol = mice(small_missing, n_imputations=4, max_iter=2, seed=0)
    ...
    def test_pmm_imputes_observed_values_only(self, small_missing):
        ...
        # its column.
        sol = mice(small_missing, n_imputations=2, max_iter=3, method="pmm", seed=0)
...
class TestDeterminism:
    def test_same_seed_identical(self, small_missing):
        a = mice(small_missing, n_imputations=3, max_iter=4, seed=123)
        b = mice(small_missing, n_imputations=3, max_iter=4, seed=123)
        for da, db in zip(a.completed_datasets(), b.completed_datasets()):
            np.testing.assert_array_equal(da, db)

    def test_different_seed_differs(self, small_missing):
        a = mice(small_missing, n_imputations=3, max_iter=4, seed=1)
        b = mice(small_missing, n_imputations=3, max_iter=4, seed=2)
    ...
    def test_norm_method_runs_and_is_deterministic(self, small_missing):
        a = mice(small_missing, n_imputations=2, max_iter=3, method="norm", seed=5)
        b = mice(small_missing, n_imputations=2, max_iter=3, method="norm", seed=5)
        for da, db in zip(a.completed_datasets(), b.completed_datasets()):
            np.testing.assert_array_equal(da, db)
...
class TestImputationsAccessor:
    def test_imputations_shape(self, small_missing):
        sol = mice(small_missing, n_imputations=3, max_iter=2, seed=0)
    ...
    def test_imputations_unknown_column_raises(self, small_missing):
        sol = mice(small_missing, n_imputations=2, max_iter=2, seed=0)
...
class TestConvergenceTrace:
    def test_trace_shapes(self, small_missing):
        sol = mice(small_missing, n_imputations=3, max_iter=5, seed=0)
    ...
    def test_trace_is_finite(self, small_missing):
        sol = mice(small_missing, n_imputations=2, max_iter=5, seed=0)
...
class TestRecovery:
    def test_imputed_means_near_truth_on_mcar(self):
        ...
        sol = mice(miss, n_imputations=10, max_iter=10, method="norm", seed=9)
...
class TestSolverValidation:
    ...
    def test_no_missing_rejected(self):
        ...
        with pytest.raises(ValueError, match="no missing"):
            mice(complete, n_imputations=2, max_iter=2, seed=0)
    ...
    def test_gpu_backend_dispatch_is_explicit(self, small_missing):
        ...
        if has_gpu:
            sol = mice(small_missing, n_imputations=2, max_iter=2, seed=0, backend="gpu")
            assert "gpu" in sol.backend_name
        else:
            with pytest.raises((RuntimeError, NotImplementedError)):
                mice(small_missing, n_imputations=2, max_iter=2, seed=0, backend="gpu")

    def test_accepts_prebuilt_design(self, small_missing):
        design = MICEDesign.from_array(small_missing, method="norm")
        sol = mice(design, n_imputations=2, max_iter=2, seed=0)
        assert sol.n_imputations == 2

    def test_design_ignores_method_with_warning(self, small_missing):
        design = MICEDesign.from_array(small_missing)
        with pytest.warns(UserWarning):
            mice(design, n_imputations=2, max_iter=2, seed=0, method="norm")
